...
class Peer extends EnhancedEventEmitter
{
			...
			.then(() =>
			{
				switch (method)
				{
					case 'createTransport':
					{
						...
						{
							plainRtpParameters.preferIPv4 = options.preferIPv4 || false;
							plainRtpParameters.preferIPv6 = options.preferIPv6 || false;
	...
	_createPlainRtpTransport(id, direction, options, appData)
	{
		...
		return this._channel.request('router.createPlainRtpTransport', internal,
			{
				remoteIP   : options.ip,
